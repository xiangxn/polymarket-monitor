...
export const getConfig = () => {
    return {
        ...
        TREND_THRESHOLD: parseFloat(process.env.TREND_THRESHOLD ?? "0.0002"),   // 趋势阈值 0.02% -> 0.0002
        ...
        MAX_ENTRY_PRICE: parseFloat(process.env.MAX_ENTRY_PRICE ?? "0.68"),   // 最大入场价 0.68
        MAX_BOOK_DIFF: parseFloat(process.env.MAX_BOOK_DIFF ?? "0.25"),   // 盘口差最大值 0.25
